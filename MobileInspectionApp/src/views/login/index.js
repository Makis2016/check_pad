                ...
                <View style={styles.container}>
                    <View style={styles.loginView}>
                        ...
                        <View style={styles.loginButtons}>
                            <Button type="primary" style={styles.loginButton} onPress={() => this._onLoginButtonClick()}>
                                登 录
                            </Button>
                        </View>
                        <View style={styles.loginButtons}>
                        ...
                        <View style={styles.switches}>
                            <View style={styles.switch}>
                                <Switch style={{ width: 50 }} color={'#034799'} checked={this.state.rememberState} onChange={(value) => this.setState({ rememberState: value })} />
                                <Text style={styles.switchText}>记住密码</Text>
                            </View>
                            <View style={styles.switch}>
                                <Switch style={{ width: 50 }} color={'#034799'} checked={this.state.autoLoginState} onChange={(value) => this.setState({ autoLoginState: value })} />
