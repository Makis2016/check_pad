        ...
        return (
            <View style={[styles.container, this.props.style]}>
                ...
                <View style={styles.dropdownContainer}>
                    <Picker itemStyle={[CommonStyles.primaryDropdown, this.props.dropdownStyle]} mode="dropdown" selectedValue={selectedValue} onValueChange={(value) => (typeof vo === 'undefined' ? this.setState({ value: value }) : (vo[vmodel] = value))}>
                        {options.map((item) => (
